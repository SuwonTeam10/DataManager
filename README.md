...
## 🎯 개발 목표
- DonkeyCar 주행 데이터 관리 및 AI 학습 과정을 C# Windows Forms GUI에서 통합 관리
  - 로컬과 원격(SSH) 실행 방식을 모두 지원하는 유연한 아키텍처 설계
  - Tub 데이터 시각화 및 필터링 기능 구현
  - 잘못된 주행 데이터 필터링 및 삭제
  - AI 학습 실행 및 실시간 로그 모니터링
  - 초보자도 사용할 수 있는 안내 중심 UI 제공
